--  Mission Elements Retrieval Script.
-- @author: zephirot
-- https://www.unknowncheats.me/forum/payday-2/120347-mission-elements-retrieval-script.html

local tableA = managers.mission:script("default")
local mission = tostring(managers.job:current_level_id())
local save_file_name = tostring(ModPath) .. mission ..".txt"
local file = io.open(save_file_name, "w")
file:close()
local file = io.open(save_file_name, "a+")
