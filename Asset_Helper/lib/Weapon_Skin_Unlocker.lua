...
-- unlock armor skin
orig_BlackMarketManager_armor_skin_unlocked = orig_BlackMarketManager_armor_skin_unlocked or BlackMarketManager.armor_skin_unlocked
function BlackMarketManager:armor_skin_unlocked(skin_id)
	if self:_is_armor_skin_valid(skin_id) then
		return true
	end
	return orig_BlackMarketManager_armor_skin_unlocked(self, skin_id)
end
