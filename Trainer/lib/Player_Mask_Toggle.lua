-- you have to wait for the animation to toggle again, or you can't put mask on again through pressing G
global_mask_toggle = not global_mask_toggle

if global_mask_toggle then
