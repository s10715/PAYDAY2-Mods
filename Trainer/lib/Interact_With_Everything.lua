...
local hacks_not_safe = {"born_plug_in_powercord","circuit_breaker","hold_hlm_open_circuibreaker","rewire_electric_box","place_flare","use_flare","gasoline","hold_attach_magnet","apply_thermite_paste","apply_thermite_paste_no_consume","hold_blow_torch","gen_prop_container_a_vault_seq","start_hacking","hold_hack_comp","security_station","security_station_keyboard","are_laptop","mcm_laptop_code","numpad","timelock_hack","hack_ipad","hack_ipad_jammed","hack_suburbia","hack_suburbia_jammed","hack_suburbia_outline","hack_suburbia_jammed","hack_suburbia_jammed_axis","hack_suburbia_jammed_y","votingmachine2","votingmachine2_jammed","crane_joystick_left","crane_joystick_release","connect_hose","generator_start","hold_move_crane","hold_search_dumpster","hold_release_hatch","bus_wall_phone","hold_wwh_untie","open_lid_wwh","connect_hose_wwh","connect_hose_pump_wwh","connect_hose_ship_wwh","hold_generator_start","hold_remove_rope","detach_hose_wwh","hold_move_gangplank","hold_moon_untie","hold_born_untie","hold_born_search_tools","open_slash_close_sec_box","hold_pull_switch","hold_pull_switch_distance","iphone_answer","use_computer","hold_use_computer","use_server_device","hack_trai_outline","hack_ship_control","hold_remove_debris","hold_activate_sprinklers","hold_turn_off_sprinklers","hospital_security_cable_red","hospital_security_cable_blue","hospital_security_cable_green","hospital_security_cable_yellow","hold_cut_cable","shelf_sliding_suburbia","pent_generator_start","uno_pull_lever","uno_press_activate","uno_mayan_gold_bar","hold_hack_computer","hold_hack_comp"}
